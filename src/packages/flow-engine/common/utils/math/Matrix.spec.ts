...
describe('Matrix', () => {
    ...
    test('fromArray', async () => {
        ...
        expect(new M().fromArray([0, 1, 2, 3, 4, 5])).toEqual(
            new M(0, 1, 3, 4, 2, 5),
        )
        expect(new M().fromArray([0, 1, 2, 3, 4, 5, 6])).toEqual(
            new M(0, 1, 3, 4, 2, 5),
        )
    })
    ...
    test('apply', async () => {
        ...
        expect(new M(1, 1, -1, 1).apply({ x: 1, y: 2 })).toEqual({
            x: -1,
            y: 3,
        })
    })
    ...
    test('append', async () => {
        ...
        expect(M.IDENTITY.append(new M(0, 1, 2, 3, 4, 5))).toEqual(
            new M(0, 1, 2, 3, 4, 5),
        )
        expect(new M(0, 1, 2, 3, 4, 5).append(M.IDENTITY)).toEqual(
            new M(0, 1, 2, 3, 4, 5),
        )
    ...
    test('prepend', async () => {
        ...
        expect(M.IDENTITY.prepend(new M(0, 1, 2, 3, 4, 5))).toEqual(
            new M(0, 1, 2, 3, 4, 5),
        )
        expect(new M(0, 1, 2, 3, 4, 5).prepend(M.IDENTITY)).toEqual(
            new M(0, 1, 2, 3, 4, 5),
        )
        expect(
            new M(0, 1, 2, 3, 4, 5).prepend(new M(0, 1, 2, 3, 1, 2)),
        ).toEqual(new M(2, 3, 6, 11, 11, 21))
    })
    ...
    test('invert', async () => {
        expect(new M(0, 1, 2, 3, 4, 5).invert()).toEqual(
            new M(-1.5, 0.5, 1, -0, 1, -2),
        )
        expect(new M(-1.5, 0.5, 1, -0, 1, -2).invert()).toEqual(
            new M(0, 1, 2, 3, 4, 5),
        )
    ...
    test('copyTo', async () => {
        expect(new M(0, 1, 2, 3, 4, 5).copyTo(M.TEMP_MATRIX)).toEqual(
            new M(0, 1, 2, 3, 4, 5),
        )
    })

    test('copyFrom', async () => {
        expect(M.TEMP_MATRIX.copyFrom(new M(0, 1, 2, 3, 4, 5))).toEqual(
            new M(0, 1, 2, 3, 4, 5),
        )
    })
