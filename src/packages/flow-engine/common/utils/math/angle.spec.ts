...
describe('Angle', () => {
    ...
    test('betweenPoints', async () => {
        ...
        expect(Angle.betweenPoints({ x: 1, y: 0 }, { x: 0, y: 1 })).toEqual(
            PI / 2,
        )
        expect(Angle.betweenPoints({ x: 0, y: 1 }, { x: 1, y: 0 })).toEqual(
            -PI / 2,
        )
        expect(Angle.betweenPoints({ x: -1, y: 0 }, { x: 1, y: 0 })).toEqual(
            -PI,
        )
