...
export const each = <T = any, K = string>(
    obj: any,
...
export const filter = (
    ...
    keys(obj).reduce(
        (output, key) =>
            fn(obj[key], key)
                ? Object.assign(output, { [key]: obj[key] })
                : output,
        dest || {},
    )
...
export const mapValues = <V = any>(
    ...
    reduce<V>(obj, (res, value, key) =>
        Object.assign(res, { [key]: fn(value, key) }),
    )

export const mapKeys = <V = any>(
    obj: any,
    fn: (value: V, key: string) => any,
) =>
    reduce<V>(obj, (res, value, key) =>
        Object.assign(res, { [fn(value, key)]: value }),
    )
