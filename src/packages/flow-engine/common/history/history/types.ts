...
export interface UndoRedoChangeElementEvent {
    type:
        | UndoRedoChangeType.PUSH
        | UndoRedoChangeType.UNDO
        | UndoRedoChangeType.REDO
 ...
 * undo redo变化事件
 */
export type UndoRedoChangeEvent =
    | UndoRedoChangeElementEvent
    | UndoRedoClearEvent
 ...
 * 更新操作事件
 */
export interface HistoryStackUpdateOperationEvent
    extends HistoryStackBaseEvent {
