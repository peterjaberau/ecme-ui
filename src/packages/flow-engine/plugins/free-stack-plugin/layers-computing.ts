...
namespace NodeComputing {
    ...
    export const stackingIndex = (
        ...
        const zIndex =
            StackingConfig.startIndex +
            StackingConfig.levelIndexStep * (level - 1) +
            baseZIndex
        return zIndex
    }
    ...
    export const nodeStackingLevel = (
        ...
        const topLevel =
            StackingConfig.allowLevel + (linage.length - topLevelIndex)
...
namespace LineComputing {
    ...
    const lineStackingLevel = (
        ...
        const fromLevel = NodeComputing.nodeStackingLevel(
            line.from,
            context,
            true,
        )
