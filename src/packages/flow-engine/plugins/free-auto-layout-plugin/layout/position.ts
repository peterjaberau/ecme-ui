...
import { PositionSchema, startTween, TransformData } from '@flow/canvas-core'
...
export class LayoutPosition {
    ...
    private updateNodePosition(params: {
        ...
        const deltaY =
            ((position.y - transform.bounds.height / 2 - transform.position.y) *
                step) /
            100
