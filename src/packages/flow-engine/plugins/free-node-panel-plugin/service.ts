...
import { WorkflowSelectService } from '@flow/free-layout-core'
import { WorkflowNodeJSON } from '@flow/free-layout-core'
import { HistoryService } from '@flow/free-history-plugin'
import { PlaygroundConfigEntity } from '@flow/canvas-core'
...
export class WorkflowNodePanelService {
    ...
    public async singleSelectNodePanel(
        params: Omit<
            CallNodePanelParams,
            'onSelect' | 'onClose' | 'enableMultiAdd'
        >,
    ...
    private async addNode(
        ...
        const selectPosition =
            this.playgroundConfig.getPosFromMouseEvent(selectEvent)
