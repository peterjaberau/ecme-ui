...
import { FormItem } from '@flow/form-core'
...
export interface VariableAbilityParseContext
    extends VariableAbilityCommonContext {}

export interface VariableProviderAbilityOptions<V = any>
    extends VariableAbilityOptions {
    // 解析变量协议
    parse: (v: V, ctx: VariableAbilityParseContext) => VariableDeclarationJSON[]
}

export interface VariableConsumerAbilityOptions<V = any>
    extends VariableAbilityOptions {
    // 解析变量协议
