...
import { StackingContextManager } from '@flow/free-stack-plugin'
import {
    nanoid,
    WorkflowDocument,
...
export class WorkflowLinesLayer extends Layer<LinesLayerOptions> {
     ...
     * 节点线条
     */
    public node = domUtils.createDivWithClass(
        'gedit-playground-layer gedit-flow-lines-layer',
    )
    ...
    private renderLine(line: WorkflowLineEntity): ReactNode {
        ...
        const portal = ReactDOM.createPortal(
            this.lineComponent(lineProps),
            line.node,
        )
        this.mountedLines.set(line.id, {
            line,
            portal,
            version: lineProps.version,
        })
        return portal
    }
