...
export const WorkflowPortRender: React.FC<WorkflowPortRenderProps> =
    ...
    React.memo<WorkflowPortRenderProps>((props: WorkflowPortRenderProps) => {
        const hoverService =
            useService<WorkflowHoverService>(WorkflowHoverService)
        const linesManager =
            useService<WorkflowLinesManager>(WorkflowLinesManager)
        ...
        const content = (
            <WorkflowPointStyle
                ...
                style={
                    targetElement
                        ? props.style
                        : { ...props.style, left: posX, top: posY }
                }
                onClick={onClick}
            ...
            >
                <div
                    className={classNames('bg-circle', 'workflow-bg-circle')}
                ></div>
                <div
