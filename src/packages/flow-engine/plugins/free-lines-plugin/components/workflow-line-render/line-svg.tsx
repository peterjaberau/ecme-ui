...
import { POINT_RADIUS } from '@flow/free-layout-core'
import { WorkflowLineRenderData } from '@flow/free-layout-core'
    ...
    const path = (
        <path
            ...
            className={clsx(
                ...
                !line.className &&
                    (line.processing || line.flowing
                        ? 'dashed-line flowing-line'
                        : ''),
            )}
        />
    )
