...
import { IPoint, Point, Rectangle } from '@flow/utils'
import {
    POINT_RADIUS,
    WorkflowLineEntity,
    WorkflowLineRenderContribution,
} from '@flow/free-layout-core'
import { LineType } from '@flow/free-layout-core'
...
export class WorkflowBezierLineContribution
    implements WorkflowLineRenderContribution
{
