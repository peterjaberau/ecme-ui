...
import { FlowRendererKey, FlowRendererRegistry } from '@flow/canvas-renderer'
...
export const createMaterialsPlugin =
    definePluginCreator<MaterialsPluginOptions>({
        onInit(ctx, opts) {
