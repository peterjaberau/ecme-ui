...
import { HistoryContainerModule, OperationContribution } from '@flow/history'
...
export const createFreeHistoryPlugin =
    definePluginCreator<FreeHistoryPluginOptions>({
        onBind: ({ bind }) => {
            bindContributions(bind, FreeHistoryRegisters, [
