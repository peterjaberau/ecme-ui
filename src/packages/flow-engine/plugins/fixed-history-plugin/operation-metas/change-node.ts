import { ChangeNodeOperationValue, OperationType } from '@flow/canvas-document'
...
export const changeNodeOperationMeta: OperationMeta<
    ChangeNodeOperationValue,
    PluginContext,
    void
> = {
    ...baseOperationMeta,
    ...
    apply: (operation, ctx) => {
        ...
        const formData = fixedFormDataService.getFormDataByNodeId(
            operation.value.id,
        )
        ...
        fixedFormDataService.setFormItemValue(
            formData,
