...
import { ConfigEntity } from '@flow/canvas-core'
import { Compare, Rectangle } from '@flow/utils'
...
export class FlowSelectConfigEntity extends ConfigEntity<FlowSelectConfigEntityData> {
    ...
    set selectedNodes(nodes: FlowNodeEntity[]) {
        ...
        if (
            ...
            if (
                Compare.isArrayShallowChanged(this.config.selectedNodes, nodes)
            ) {
                this.updateConfig({
                    selectedNodes: nodes,
                })
