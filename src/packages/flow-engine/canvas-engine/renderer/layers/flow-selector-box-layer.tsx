...
import { domUtils, PositionSchema } from '@flow/utils'
import {
    FlowDocument,
    FlowNodeEntity,
    ...
    protected selectboxDragger = new PlaygroundDrag({
        ...
        onDrag: (e) => {
            ...
            this.selectConfigEntity.selectFromBounds(
                this.selectorBoxConfigEntity.toRectangle(
                    this.playgroundConfigEntity.finalScale,
                ),
    ...
    onReady(): void {
        ...
        this.toDispose.pushAll([
            ...
            this.selectionService.onSelectionChanged(() => {
                ...
                this.selectConfigEntity.selectedNodes =
                    selectedNodes as FlowNodeEntity[]
            }),
        ])
        this.listenPlaygroundEvent(
            ...
            (e: MouseEvent): boolean | undefined => {
                ...
                // 自定义拦截选择框事件
                if (
                    this.options.canSelect &&
                    !this.options.canSelect(e, this.selectorBoxConfigEntity)
                ) {
                    return
                }
