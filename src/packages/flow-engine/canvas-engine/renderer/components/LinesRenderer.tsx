...
import { getDefaultSpacing } from '@flow/canvas-document'
...
export function createLines(props: PropsType): void {
    ...
    const xRadius = getDefaultSpacing(
        entity,
        DefaultSpacingKey.ROUNDED_LINE_X_RADIUS,
    )
    const yRadius = getDefaultSpacing(
        entity,
        DefaultSpacingKey.ROUNDED_LINE_Y_RADIUS,
    )
