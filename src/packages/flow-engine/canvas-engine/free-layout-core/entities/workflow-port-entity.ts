import { type IPoint, Rectangle, Emitter } from '@flow/utils'
...
export class WorkflowPortEntity extends Entity<WorkflowPortEntityOpts> {
    ...
    validate() {
        ...
        // 如果没有连线错误，需校验端口自身错误
        const isPortHasError = (
            this.node.document as WorkflowDocument
        ).isErrorPort(this)
