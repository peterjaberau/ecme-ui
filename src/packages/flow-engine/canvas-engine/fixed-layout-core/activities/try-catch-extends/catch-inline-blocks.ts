...
export const CatchInlineBlocksRegistry: FlowNodeRegistry = {
    ...
    getLabels(transition) {
        ...
        const actualInputPoint = {
            x: isVertical
                ? inputPoint.x
                : inputPoint.x - TryCatchSpacings.CATCH_INLINE_SPACING,
            y: isVertical
                ? inputPoint.y - TryCatchSpacings.CATCH_INLINE_SPACING
                : inputPoint.y,
        }
        ...
        return [
            {
                ...
                props: {
                    // 激活状态
                    activated:
                        transition.entity.getData(FlowNodeRenderData)!
                            .activated,
    ...
    getInputPoint(transform, layout) {
        ...
        return isVertical
            ? transform.bounds.topCenter
            : transform.bounds.rightCenter
    },
