import { FlowRendererKey, FlowTextKey } from '@flow/canvas-renderer'
import {
    DEFAULT_SPACING,
    FlowNodeBaseType,
...
export const MainInlineBlocksRegistry: FlowNodeRegistry = {
    ...
    getLabels(transition) {
        ...
        const errLabelX = isVertical
            ? (transform.parent!.outputPoint.x +
                  catchInlineBlocks.inputPoint.x) /
              2
        ...
        const errLabelY = isVertical
            ...
            : (transform.parent!.outputPoint.y +
                  catchInlineBlocks.inputPoint.y) /
              2
        ...
        return [
            {
                ...
                offset: {
                    x: isVertical
                        ...
                        : transform.inputPoint.x +
                          TryCatchSpacings.TRY_START_LABEL_DELTA,
                    y: isVertical
            ...
            },
            {
                ...
                offset: {
                    x: isVertical
                        ? transform.inputPoint.x
                        : transform.originParent!.outputPoint.x +
                          TryCatchSpacings.TRY_END_LABEL_DELTA,
                    y: isVertical
                        ? transform.originParent!.outputPoint.y +
                          TryCatchSpacings.TRY_END_LABEL_DELTA
                        : transform.inputPoint.y,
                },
            },
        ...
        if (isVertical) {
            return {
                ...
                y:
                    ...
                    TryCatchSpacings.CATCH_INLINE_SPACING,
            }
        }
        return {
