...
const JSONTreeArrayNode = ({ data, path, ...restProps }) => {
  ...
  const renderRange = (start, end) => {
    ...
    if (!isExpanded) {
      return (
        <Container fluid className="json-node-element">
            <Stack direction='row'>
              <div className="json-tree-icon-container">
              ...
              <div class="false false " style={{ width: 'inherit' }}>
                <Flex class="inspector-json-node">
                  <span
                    class="node-key  badge badge-outline node-key-outline"
