...
import { handleLowPriorityWork } from '@/views/actors/playground/_helpers/editorHelpers'
import { useMounted } from '@/views/actors/playground/_hooks/use-mount'
        ...
        >
            ...
            >
                ...
                <CodeHinter.Portal
                    ...
                    optionalProps={{
                        styles: { height: 300 },
                        cls: 'tjdb-hinter-portal',
                    }}
                    darkMode={darkMode}
                    selectors={{
                        className:
                            'preview-block-portal tjdb-portal-codehinter',
                    }}
                ...
                >
                    <ErrorBoundary>
                        <div
                            className={`${errorState && 'tjdb-hinter-error'} h-100`}
                        ...
                        <div
                            className={` ${isOpen ? 'd-block footer-component' : 'd-none'}`}
                        >
                            {footerComponent()}
                        </div>
                    </ErrorBoundary>
