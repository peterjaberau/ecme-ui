...
export const Button = function Button(props: any) {
  ...
  const iconName: any = styles.icon; // Replace with the name of the icon you want
  // @ts-ignore
  ...
  useEffect(() => {
    const exposedVariables = {
      ...
      setText: async function (text: any) {
        setLabel(text);
        setExposedVariable('buttonText', text);
      },
      disable: async function (value: any) {
        setDisable(value);
      },
      visibility: async function (value: any) {
        setVisibility(value);
      },
      loading: async function (value: any) {
        setLoading(value);
      },
    };
  ...
  useEffect(() => {
    setExposedVariable('setLoading', async function (loading: any) {
      setLoading(loading);
  ...
  useEffect(() => {
    setExposedVariable('setVisibility', async function (state: any) {
      setVisibility(state);
  ...
  useEffect(() => {
    setExposedVariable('setDisable', async function (disable: any) {
      setDisable(disable);
